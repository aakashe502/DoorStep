...
public class ModelAdapter extends RecyclerView.Adapter {
    ...
    static class TopPicksModelViewHolder extends RecyclerView.ViewHolder {
    ...
    static class TopRestrauntViewHolder extends RecyclerView.ViewHolder {
        RecyclerView recyclerView123;
        public TopRestrauntViewHolder(@NonNull View itemView)
        {
            super(itemView);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent,int viewType) {
        switch (viewType) {
            ...
            case Layoutthree:
                ...
                return new TopRestrauntViewHolder(layoutthree);
            case Layoutfour:
...
//                ((LayoutOneViewHolder)holder).setView(text);
            ...
            case Layoutthree:
                ...
                ((TopRestrauntViewHolder)holder).recyclerView123.setLayoutManager(gridLayoutManager2);
                ((TopRestrauntViewHolder)holder).recyclerView123.setAdapter(adapter1);
                break;
            case Layoutfour:
